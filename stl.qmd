...
```{r}
data_asturias %>%
      gg_tsdisplay(((box_cox(num_casos, lambda_asturias))),
...
```{r}
data_asturias %>%
      gg_tsdisplay((difference(box_cox(num_casos, lambda_asturias))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_asturias %>%
      gg_tsdisplay(difference(difference(box_cox(num_casos, lambda_asturias))),
                   plot_type = 'partial', lag = 30) +
...
data_asturias %>% 
      ...
      select(trend) %>%
      gg_tsdisplay(trend, plot_type = 'partial', lag = 30) +
      labs(title="Asturias - Orginal STL")
```
...
```{r}
data_barcelona %>%
      gg_tsdisplay(((box_cox(num_casos, lambda_barcelona))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_barcelona %>%
      gg_tsdisplay((difference(box_cox(num_casos, lambda_barcelona))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_barcelona %>%
      gg_tsdisplay(difference(difference(box_cox(num_casos, lambda_barcelona))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_madrid %>%
      gg_tsdisplay(((box_cox(num_casos, lambda_madrid))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_madrid %>%
      gg_tsdisplay((difference(box_cox(num_casos, lambda_madrid))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_madrid %>%
      gg_tsdisplay(difference(difference(box_cox(num_casos, lambda_madrid))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_malaga %>%
      gg_tsdisplay(((box_cox(num_casos, lambda_malaga))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_malaga %>%
      gg_tsdisplay((difference(box_cox(num_casos, lambda_malaga))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_malaga %>%
      gg_tsdisplay(difference(difference(box_cox(num_casos, lambda_malaga))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_sevilla %>%
      gg_tsdisplay(((box_cox(num_casos, lambda_sevilla))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_sevilla %>%
      gg_tsdisplay((difference(box_cox(num_casos, lambda_sevilla))),
                   plot_type = 'partial', lag = 30) +
...
```{r}
data_sevilla %>%
      gg_tsdisplay(difference(difference(box_cox(num_casos, lambda_sevilla))),
                   plot_type = 'partial', lag = 30) +
...
data_sevilla %>% 
      ...
      select(trend) %>%
      gg_tsdisplay(trend, plot_type = 'partial', lag = 30) +
      labs(title="Sevilla - Orginal STL")
```
